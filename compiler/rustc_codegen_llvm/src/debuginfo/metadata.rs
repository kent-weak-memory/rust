...
fn build_fixed_size_array_di_node<'ll, 'tcx>(
    ...
    let (memory_size, align) = cx.size_and_align_of(array_type);
...
fn build_vtable_type_di_node<'ll, 'tcx>(
    ...
    let (pointer_memory_size, pointer_align) = cx.size_and_align_of(void_pointer_ty);
