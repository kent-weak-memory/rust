...
pub fn low_align_const() -> E<i16, [i16; 3]> {
    ...
    // NONCHERI: memcpy.{{.+}}({{i8\*|ptr}} align 2 %{{[0-9]+}}, {{i8\*|ptr}} align 2 {{.*}}[[LOW_HIGH]]{{.*}}, i{{(32|64)}} 8, i1 false)
    // CHERI: memcpy.{{.+}}({{i8 addrspace\(200\)\*|ptr addrspace\(200\)}} align 2 %{{[0-9]+}}, {{i8 addrspace\(200\)\*|ptr addrspace\(200\)}} align 2 {{.*}}[[LOW_HIGH]]{{.*}}, i{{(32|64)}} 8, i1 false)
    *&E::A(0)
}
...
pub fn high_align_const() -> E<i16, i32> {
    // Check that low_align_const and high_align_const use the same constant
    // NONCHERI: memcpy.{{.+}}({{i8\*|ptr}} align 4 %{{[0-9]+}}, {{i8\*|ptr}} align 4 {{.*}}[[LOW_HIGH]]{{.*}}, i{{(32|64)}} 8, i1 false)
    // CHERI: memcpy.{{.+}}({{i8 addrspace\(200\)\*|ptr addrspace\(200\)}} align 4 %{{[0-9]+}}, {{i8 addrspace\(200\)\*|ptr addrspace\(200\)}} align 4 {{.*}}[[LOW_HIGH]]{{.*}}, i{{(32|64)}} 8, i1 false)
    *&E::A(0)
}
