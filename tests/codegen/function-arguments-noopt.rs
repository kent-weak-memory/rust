...
// CHECK: align 4 {{i32( addrspace\(200\))?\*|ptr( addrspace\(200\))?}} @borrow({{i32( addrspace\(200\))?\*|ptr( addrspace\(200\))?}} align 4 %x)
#[no_mangle]
pub fn borrow(x: &i32) -> &i32 {
  x
}

// CHECK: align 4 {{i32( addrspace\(200\))?\*|ptr( addrspace\(200\))?}} @borrow_mut({{i32( addrspace\(200\))?\*|ptr( addrspace\(200\))?}} align 4 %x)
#[no_mangle]
...
pub fn borrow_call(x: &i32, f: fn(&i32) -> &i32) -> &i32 {
  // CHECK: call align 4 {{i32( addrspace\(200\))?\*|ptr( addrspace\(200\))?}} %f({{i32( addrspace\(200\))?\*|ptr( addrspace\(200\))?}} align 4 %x)
  f(x)
}

// CHECK: void @struct_({{%S( addrspace\(200\))?\*|ptr( addrspace\(200\))?}} sret(%S){{( %0)?}}, {{%S( addrspace\(200\))?\*|ptr( addrspace\(200\))?}} %x)
#[no_mangle]
...
pub fn struct_call(x: S, f: fn(S) -> S) -> S {
  // CHECK: call void %f({{%S( addrspace\(200\))?\*|ptr( addrspace\(200\))?}} sret(%S){{( %0)?}}, {{%S( addrspace\(200\))?\*|ptr( addrspace\(200\))?}} %{{.+}})
  f(x)
}
