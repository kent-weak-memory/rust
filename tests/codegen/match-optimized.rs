...
//
// CHECK: [[A]]:
// CHECK-NEXT: store i8 0, {{i8( addrspace\(200\))?\*|ptr( addrspace\(200\))?}} %1, align 1
// CHECK-NEXT: br label %[[EXIT:[a-zA-Z0-9_]+]]
// CHECK: [[B]]:
// CHECK-NEXT: store i8 1, {{i8( addrspace\(200\))?\*|ptr( addrspace\(200\))?}} %1, align 1
// CHECK-NEXT: br label %[[EXIT]]
// CHECK: [[C]]:
// CHECK-NEXT: store i8 2, {{i8( addrspace\(200\))?\*|ptr( addrspace\(200\))?}} %1, align 1
// CHECK-NEXT: br label %[[EXIT]]
    match e {
        E::A => 0,
        E::B => 1,
